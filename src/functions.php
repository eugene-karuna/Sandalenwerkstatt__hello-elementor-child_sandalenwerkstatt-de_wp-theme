<?php
/**
 * Sandalenwerkstatt Hello Elementor Child Sandalenwerkstatt De Wp Theme Childtheme init
 *
 * @package Sandalenwerkstatt__hello-elementor-child_sandalenwerkstatt-de_wp-theme
 */
...
function sandale_init() {
	...
	// see ./classes/Sandale.php
	return sandale\Sandale::get_instance( $init_args );
}
sandale_init();
